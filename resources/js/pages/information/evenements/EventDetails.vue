...
<template>
    <div class="min-h-screen flex flex-col bg-gradient-to-tr from-[#6F4786] to-[#2D0B47]">
        ...
        <main class="flex-grow container mx-auto px-4 py-8">
            ...
            <Card class="bg-white/10 backdrop-blur-sm border-none mb-6">
                <CardHeader>
                    <CardTitle class="text-xl font-semibold text-[#E4F1F1]">Informations principales</CardTitle>
                </CardHeader>
                <CardContent>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            <div class="flex items-center gap-2 text-[#E4F1F1]">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div v-if="evenement.meteo" class="flex items-center gap-2 text-[#E4F1F1]">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
