...
<template>
    <AuthLayout title="Vérifier l'e-mail" description="Veuillez vérifier votre adresse e-mail en cliquant sur le lien que nous venons de vous envoyer par e-mail.">
