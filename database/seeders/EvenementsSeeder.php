    ...
    public function run(): void
    {
        $evenements = [
            [
                ...
                'logo_equipe_domicile' => '/images/logos/Paris_Saint-Germain_Logo.png',
                'logo_equipe_exterieur' => '/images/logos/Logo_Olympique_de_Marseille.png',
                'resultat' => 'victoire',
            ...
            [
                ...
                'activites_autour' => 'Boutique officielle, restaurants, bars, zone de restauration rapide.',
                'logo_equipe_domicile' => '/images/logos/Paris_Saint-Germain_Logo.png',
                'logo_equipe_exterieur' => '/images/logos/Logo_OGC_Nice.png',
                'resultat' => 'nul',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'consignes_securite' => 'Interdiction d\'apporter des objets dangereux. Les sacs seront fouillés à l\'entrée.',
                'activites_autour' => 'Boutique officielle, restaurants, bars, zone de restauration rapide.',
                'logo_equipe_domicile' => '/images/logos/artiste-logo.png',
                'logo_equipe_exterieur' => '/images/logos/premiere-partie-logo.png',
                'resultat' => null,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
                ...
                'activites_autour' => 'Boutique officielle, restaurants, bars, zone de restauration rapide.',
                'logo_equipe_domicile' => '/images/logos/Paris_Saint-Germain_Logo.png',
                'logo_equipe_exterieur' => '/images/logos/Manchester_City_Logo.png',
                'resultat' => 'defaite',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
