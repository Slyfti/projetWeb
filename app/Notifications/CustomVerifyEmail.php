...
class CustomVerifyEmail extends VerifyEmail
{
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
            ...
            ->greeting('Bonjour!')
            ->line('Merci de vous être inscrit sur notre plateforme. Pour activer votre compte, veuillez cliquer sur le bouton ci-dessous pour vérifier votre adresse email.')
